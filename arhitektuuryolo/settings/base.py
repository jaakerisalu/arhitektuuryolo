"""
Django settings for Arhitektuuri Lõpuprojekt project.
...
MANAGERS = ADMINS
EMAIL_SUBJECT_PREFIX = '[Arhitektuuri Lõpuprojekt] '  # subject prefix for managers & admins

SESSION_COOKIE_NAME = 'arhitektuuryolo_ssid'
...
TEMPLATE_CONTEXT_PROCESSORS = [
    ...
    'arhitektuuryolo.context_processors.settings_export',
]
TEMPLATE_LOADERS = [
...
ROOT_URLCONF = 'arhitektuuryolo.urls'

WSGI_APPLICATION = 'arhitektuuryolo.wsgi.application'
...
# Email config
DEFAULT_FROM_EMAIL = "Arhitektuuri Lõpuprojekt <info@TODO.com>"
SERVER_EMAIL = "Arhitektuuri Lõpuprojekt server <server@TODO.com>"
